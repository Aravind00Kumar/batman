...
// Comment that is displayed in the API documentation for the Batman core module:
/**
 * Welcome to the API documentation of the **Batman Core** library.
 *
 */

/**
 * A virtual representation of a DOM Node. It assumes that [[VNode]] objects are never modified externally.
...
export interface VNode {
  ...
  /**
   * Used by core library to store the domNode that was produced from this [[VNode]].
   */
  domNode: Node | null;
}
...
export interface VNodeProperties {
   ...
   *
   * Note: if you use innerHTML, it cannot protect you from XSS vulnerabilities and you must make sure that the innerHTML value is safe.
   */
 ...
 *
 * This interface is not used anywhere in the core source code, but this is a widely used pattern.
 */
