(function (module) {
    ...
    function ColumnsOptions(element, options) {
        var _that = this;
        this.__proto__ = new BaseComponent(element, 'ColumnsOptions', options);
        this.render = function () {
            return h('div.flex', [
                h('div', [
                    h('input', { type: 'checkbox', onchange: this.updateCol.bind(this, this.options.data[0], 0), key: this.options.data[0].name, checked: this.options.data[0].isVisible != false }), h('span', [this.options.data[0].text]), h('br'),
                    h('input', { type: 'checkbox', onchange: this.updateCol.bind(this, this.options.data[1], 1), key: this.options.data[1].name, checked: this.options.data[1].isVisible != false }), h('span', [this.options.data[1].text]), h('br'),
                ]),
                h('div', [
                    h('input', { type: 'checkbox', onchange: this.updateCol.bind(this, this.options.data[2], 2), key: this.options.data[2].name, checked: this.options.data[2].isVisible != false }), h('span', [this.options.data[2].text]), h('br'),
                    h('input', { type: 'checkbox', onchange: this.updateCol.bind(this, this.options.data[3], 3), key: this.options.data[3].name, checked: this.options.data[3].isVisible != false }), h('span', [this.options.data[3].text]), h('br'),
                ]),
                h('div', [
                    h('input', { type: 'checkbox', onchange: this.updateCol.bind(this, this.options.data[4], 4), key: this.options.data[4].name, checked: this.options.data[4].isVisible != false }), h('span', [this.options.data[4].text]), h('br'),
                    h('input', { type: 'checkbox', onchange: this.updateCol.bind(this, this.options.data[5], 5), key: this.options.data[5].name, checked: this.options.data[5].isVisible != false }), h('span', [this.options.data[5].text]), h('br'),
                ]),
                h('div', [
                    h('input', { type: 'checkbox', onchange: this.updateCol.bind(this, this.options.data[6], 6), key: this.options.data[6].name, checked: this.options.data[6].isVisible != false }), h('span', [this.options.data[6].text]), h('br'),
                    h('input', { type: 'checkbox', onchange: this.updateCol.bind(this, this.options.data[7], 7), key: this.options.data[7].name, checked: this.options.data[7].isVisible != false }), h('span', [this.options.data[7].text]), h('br'),
                ])
            ]);
        }
        this.updateCol = function (item, index) {
            if(item.isVisible === undefined) item.isVisible = true;
            if (typeof item.isVisible === 'string') {
                item.isVisibled = item.isVisible === 'false' ? false : true;
            }
    ...
    module.components.ColumnsOptions = ColumnsOptions;
    ...
    module.controller('tableBasicController', function () {
        ...
        this.tableColumns = [{ name: 'id', text: 'ID', width: 120, isVisible: true },
        ...
        { name: 'email', text: 'Email', width: 240, template: '<strong [value]="email"></strong>', isVisible: true },
        ...
        this.onload = function (view) {
            var colCOmponent = new module.components.ColumnsOptions(view.querySelector('#colOptions'), {
                data: this.tableColumns,
                refresh: function () {
                    tableComponent.refresh();
                }
            });
            var tableComponent = new Table(view.querySelector('#t1'), {
                data: this.data,
                height: 40,
                pageSize: 15,
                sortColumn:'',
