...
var appRoutes = [
    ...
    { path: 'list-home', component: list_components_1.ListHomeComponent },
    { path: 'list-basic', component: list_components_1.BasicListComponent },
    { path: 'list-auto-resize', component: list_components_1.BasicListComponent }
];
