...
/******/
/******/ 	// __webpack_public_path__
/******/ 	__webpack_require__.p = "/dist/output/core/";
/******/
/******/ 	// Load entry module and return exports
...
var Projection_1 = __webpack_require__(5);
var Projector_1 = __webpack_require__(6);
var ProjectionFactory = (function () {
    ...
    ProjectionFactory.createProjection = function (vnode, projectionOptions) {
        return new Projection_1.XProjection(vnode, projectionOptions);
    };
...
var ProjectorFactory = (function () {
    ...
    ProjectorFactory.createProjector = function (projectorOptions) {
        return new Projector_1.XProjector(projectorOptions);
    };
...
var Configuration = (function () {
    ...
    Configuration.setOptions = function (options) {
        Configuration._options = __assign({}, Configuration._options, options);
    };
    Configuration.getOptions = function () {
 ...
 *
 */
exports.hParser = function (element, context) {
    ...
    if (selector !== "svg") {
        ...
        for (var i = 0; i < element.childNodes.length; i++) {
            ...
            children.push(exports.hParser(child, context));
        }
    }
    ...
    return exports.h(selector, properties, [children.filter(function (c) { return !!c; })]);
};
...
var dom = (function () {
    ...
    dom.create = function (vnode, projectionOptions) {
        ...
        return factory_1.ProjectionFactory.createProjection(vnode, projectionOptions);
    };
    /**
...
var console_writer_1 = __webpack_require__(8);
var Logger = (function () {
    /**
    ...
    function Logger(writer, options) {
        ...
        if (writer === undefined)
            this._writer = new console_writer_1.ConsoleWriter();
        else
            this._writer = writer;
        this._stack = [];
    ...
    Logger.prototype.writeLog = function (value, type) {
        if (this.options.enable) {
            var message = new message_1.Message(value, type);
...
var XProjection = (function () {
    ...
    XProjection.prototype.update = function (updatedVnode) {
        ...
        dom_1.dom.updateDom(this.vnode, updatedVnode, this.projectionOptions);
        this.vnode = updatedVnode;
    };
    return XProjection;
}());
exports.XProjection = XProjection;
...
var XProjector = (function () {
    ...
    XProjector.prototype.append = function (parentNode, renderMaquetteFunction) {
        this.projections.push(dom_1.dom.append(parentNode, renderMaquetteFunction(), this.projectionOptions));
    ...
    XProjector.prototype.insertBefore = function (beforeNode, renderMaquetteFunction) {
        this.projections.push(dom_1.dom.insertBefore(beforeNode, renderMaquetteFunction(), this.projectionOptions));
        this.renderFunctions.push(renderMaquetteFunction);
    };
    XProjector.prototype.merge = function (domNode, renderMaquetteFunction) {
        this.projections.push(dom_1.dom.merge(domNode, renderMaquetteFunction(), this.projectionOptions));
        this.renderFunctions.push(renderMaquetteFunction);
    };
    XProjector.prototype.replace = function (domNode, renderMaquetteFunction) {
        this.projections.push(dom_1.dom.replace(domNode, renderMaquetteFunction(), this.projectionOptions));
        this.renderFunctions.push(renderMaquetteFunction);
    };
...
var BaseComponent = (function () {
    function BaseComponent(name, element, options, projectorOptions) {
        ...
        BaseComponent.Version = global_1.Global.Version;
        this.logger = logger_1.Logger.getInstance();
        this.projector = factory_1.ProjectorFactory.createProjector();
        this.animationSpeed = global_1.Global.AnimationDuration + 'ms';
        this.configuration = new global_1.Configuration();
    ...
    BaseComponent.prototype.hParser = function (element, context) {
        ...
        return h_1.h(selector, properties, [children.filter(function (c) { return !!c; })]);
    };
    return BaseComponent;
}());
exports.BaseComponent = BaseComponent;
var global_2 = __webpack_require__(1);
exports.Configuration = global_2.Configuration;
exports.Global = global_2.Global;
var factory_2 = __webpack_require__(0);
exports.ProjectionFactory = factory_2.ProjectionFactory;
exports.ProjectorFactory = factory_2.ProjectorFactory;
var h_2 = __webpack_require__(2);
exports.h = h_2.h;
exports.hParser = h_2.hParser;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__batman_core_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__batman_core_core___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__batman_core_core__);
...
var Doughnut = (function (_super) {
    ...
    Doughnut.prototype.render = function () {
        return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__batman_core_core__["h"])('div.doughnut-component.parent', { style: "min-height:" + this.options.size + "px; min-width:" + this.options.size + "px" }, [
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__batman_core_core__["h"])('div.child', {
                'style': "transition: " + this.animationSpeed + "; transform:scale(" + (1 - (this.options.stroke) / this._scale) + ")"
            }, [__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__batman_core_core__["h"])('img', { src: this.options.image, style: this.options.image ? 'display:block' : 'display:none' }),
                __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__batman_core_core__["h"])('div.head.flex', [this.options.title])]),
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__batman_core_core__["h"])('div.child', {
                ...
                __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__batman_core_core__["h"])('svg', { "class": 'doughnut-component', viewBox: '0 0 100 100' }, [
                    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__batman_core_core__["h"])('circle', {
    ...
    Doughnut.prototype.valuesTemplate = function () {
        ...
        if (this.options.values.length > 0) {
            return this.options.values.map(function (item, index) {
                ...
                return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__batman_core_core__["h"])('path', {
                    kay: index,
    ...
    return Doughnut;
}(__WEBPACK_IMPORTED_MODULE_0__batman_core_core__["BaseComponent"]));
...
var List = (function (_super) {
    ...
    List.prototype.itemTemplate = function (item) {
        if (this.options.template !== '') {
            ...
            return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__batman_core_core__["h"])('span', [item.text]);
        }
    };
    /**
     * Virtual DOM H template method; in case of values provided it generated the multi arc template otherwise single vales template
    ...
    List.prototype.render = function () {
        var _this = this;
        return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__batman_core_core__["h"])('div.list.parent', {
            style: "height: " + this._containerHeight + "px;"
        }, [
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__batman_core_core__["h"])('div.child.container', { style: "height: " + this._containerHeight + "px;", onscroll: this.scrollEvent.bind(this) }, [
                __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__batman_core_core__["h"])('div.child.data', {
                    style: "top:" + this._containerScrollTop + "px;"
                }, [
                    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__batman_core_core__["h"])('ul.no-pad-mar', { style: "height:" + this.options.height + "px" }, [this._activeData.map(function (item, index) {
                            return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__batman_core_core__["h"])('li.flex.centery', {
                                key: _this._start + index
                            }, _this.itemTemplate(item));
                        })])
                ]),
                __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__batman_core_core__["h"])('div.ghost', { style: "height:" + this.options.data.length * this.options.height + "px" }),
            ])
        ]);
    };
...
var OptimalTree = (function (_super) {
    ...
    OptimalTree.prototype.render = function () {
        var _this = this;
        return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__batman_core_core__["h"])('div.optimal-tree.parent', {
            style: "height: " + this._containerHeight + "px;"
        }, [
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__batman_core_core__["h"])('div.child.container', { style: "height: " + this._containerHeight + "px;", onscroll: this.scrollEvent.bind(this) }, [
                __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__batman_core_core__["h"])('div.child.data', {
                    ...
                    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__batman_core_core__["h"])('ul.no-pad-mar', [this.getActiveRecords().map(function (item, index) {
                            return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__batman_core_core__["h"])('li.flex', {
                                'area-level': item.level,
                                style: "height:" + _this.options.height + "px",
                                key: item.id,
                                onclick: _this.open.bind(_this, item)
                            }, [__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__batman_core_core__["h"])('i.icon', {
                                    style: "display: " + (_this.options.caret === false ? 'none' : 'initial'),
                                    classes: { open: item.isOpened === true, close: item.isOpened === false }
                                }),
                                __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__batman_core_core__["h"])('i', {
                                    classes: (_a = {
                ...
                __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__batman_core_core__["h"])('div.ghost', { style: "height:" + this._filteredData.length * this.options.height + "px" }),
            ])
        ]);
    };
...
var Tree = (function (_super) {
    ...
    Tree.prototype.render = function () {
        return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__batman_core_core__["h"])('div.tree.parent', {
            style: "height: " + this.containerHeight + "px;"
        }, [
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__batman_core_core__["h"])('div.child.container', { style: "height: " + this.containerHeight + "px;", onscroll: this.scrollEvent.bind(this) }, [
                __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__batman_core_core__["h"])('div.child.data', {
                    style: "top:" + this.containerScrollTop + "px;"
                }, [this.recursiveRenderer()]),
                __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__batman_core_core__["h"])('div.ghost', {
    ...
    Tree.prototype.recursiveRenderer = function () {
        ...
        return this.activeData.map(function (item, index) {
            return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__batman_core_core__["h"])('div.li.flex', {
                key: _this.guid(),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__doughnut_doughnut__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__list_list__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__tree_tree__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__tree_optimal_tree__ = __webpack_require__(3);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "Doughnut", function() { return __WEBPACK_IMPORTED_MODULE_0__doughnut_doughnut__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "List", function() { return __WEBPACK_IMPORTED_MODULE_1__list_list__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "Tree", function() { return __WEBPACK_IMPORTED_MODULE_2__tree_tree__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "OptimalTree", function() { return __WEBPACK_IMPORTED_MODULE_3__tree_optimal_tree__["a"]; });
